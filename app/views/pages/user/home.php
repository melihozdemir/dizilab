                ...
                <div class="dashboard-inner">
                    ...
                    <ul class="popular-humans">
                        <li>
                            <a href="http://dizilab.com/uye/mrwhite" title="MrWhite"><img data-load-image="<?=avatar(-1)?>" src="<?=img_loader()?>" alt=""><span class="statu busy"></span></a>
                        </li>
                        <li>
                            <a href="http://dizilab.com/uye/turkyurek" title="turkyurek"><img data-load-image="<?=avatar(-1)?>" src="<?=img_loader()?>" alt=""><span class="statu busy"></span></a>
                        </li>
                        <li>
                            <a href="http://dizilab.com/uye/sezaydogan" title="sezaydogan"><img data-load-image="<?=avatar(-1)?>" src="<?=img_loader()?>" alt=""><span class="statu busy"></span></a>
                        </li>
                        <li>
                            <a href="http://dizilab.com/uye/do6an" title="do6an"><img data-load-image="<?=avatar(-1)?>" src="<?=img_loader()?>" alt=""><span class="statu out"></span></a>
                        </li>
                        <li>
                            <a href="http://dizilab.com/uye/bellerophontes" title="BELLEROPHONTES"><img data-load-image="<?=avatar(-1)?>" src="<?=img_loader()?>" alt=""><span class="statu busy"></span></a>
                        </li>
                        <li>
                            <a href="http://dizilab.com/uye/mirasm" title="MirasM"><img data-load-image="<?=avatar(-1)?>" src="<?=img_loader()?>" alt=""><span class="statu busy"></span></a>
                        </li>
                        <li>
                            <a href="http://dizilab.com/uye/iremerten" title="iremerten"><img data-load-image="<?=avatar(-1)?>" src="<?=img_loader()?>" alt=""><span class="statu out"></span></a>
                        </li>
                        <li>
                            <a href="http://dizilab.com/uye/halita" title="HalitA"><img data-load-image="<?=avatar(-1)?>" src="<?=img_loader()?>" alt=""><span class="statu busy"></span></a>
                        </li>
                        <li>
                            <a href="http://dizilab.com/uye/barisakcy" title="barisakcy"><img data-load-image="<?=avatar(-1)?>" src="<?=img_loader()?>" alt=""><span class="statu busy"></span></a>
                        </li>
                        <li>
                            <a href="http://dizilab.com/uye/calcuku" title="calcuku"><img data-load-image="<?=avatar(-1)?>" src="<?=img_loader()?>" alt=""><span class="statu busy"></span></a>
                        </li>
                        <li>
                            <a href="http://dizilab.com/uye/nyanbeg" title="nyanbeg"><img data-load-image="<?=avatar(-1)?>" src="<?=img_loader()?>" alt=""><span class="statu busy"></span></a>
                        </li>
                    </ul>
