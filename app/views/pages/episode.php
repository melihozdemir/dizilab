                ...
                <div class="right-inner">
                    ...
                    <div class="tv-series-head">
                        ...
                        <ul class="tab-menu">
                            ...
                            <li><a href="javascript:;" <?if(!isset($i['login'])):?>data-open="#login-form"<?else:?>onclick="add_watch_later(<?=$ep['id']?>)"<?endif;?>><span class="fa fa-history"></span> Sonra İzle</a></li>
                ...
                -->
                    ...
                    <div class="last-forum-topics">
						...
						<ul>
							...
							<li>
								<a href="<?=base_url($ep['permalink'].'/forum/'.$val['link'].'-'.$val['forum_id'])?>">
								<span><?=$val['name']?></span>
								6 yanıt, <?=$val['username']?> - <?=ago(strtotime($val['date']));?> </a>
							</li>
							<?php endforeach?>
						</ul>
						<?php else:?>
						...
						<?php endif;?>
						<a class="topic-more" href="<?=base_url($ep['permalink'].'/forum')?>">
						<span>Forumdan diğer başlıklar</span>9 başlık, 72 mesaj</a>
                    </div>
<div class="other-episodes" data-season="<?=$ep['season']?>">
<h3>
<span class="btn">
<a href="#" id="next" style="text-align: right">
<span class="fa fa-caret-right" style="position: relative; right: 2px"></span>
</a>
<a href="#" id="prev">
<span class="fa fa-caret-left" style="position: relative; left: 2px"></span>
</a>
<span><abbr id="current_season"></abbr> / <abbr id="total_season"></abbr></span>
</span>
...
<script type="text/rocketscript">
                season[<?php echo $season->season; ?>] = 1;
            </script>
<?php if($episodes[$season->season]):?>
<div class="oe-scroll">
<ul>
<?php foreach($episodes[$season->season] as $episode){?>
<li>
<a href="/<?php #echo $episode['permalink'];?>/sezon-<?php echo $episode['season'];?>/bolum-<?php echo $episode['episode'];?>">
<span onclick="add_to_my_watch(<?php #echo $episode['ep_id'];?>, this); return false;" class="watch active">
<span class="fa fa-check"></span>
</span>
<span class="title">
<?php echo $episode['season'];?>. Sezon <?php echo $episode['episode'];?>. Bölüm
</span>
<span class="episode-name"><?php if($episode['description'] == ''){echo 'Episode #'.$episode['season'].'.'.$episode['episode'];}{if (strlen($episode['description']) > 20) {$detay = substr($episode['description'],0,20) . "..";}else{$detay = $episode['description'];} echo $detay;}?></span>
</a>
</li>
<?php }?>
</ul>
...
<?php endif;?>
                ...
                <div class="detail-left">
                    <a class="report-btn" href="/iletisim?text=Lost%205.%20sezon%207.%20b%C3%B6l%C3%BCm%20hatal%C4%B1%20olarak%20g%C3%B6z%C3%BCk%C3%BCyor.%20L%C3%BCtfen%20d%C3%BCzeltin.&type=5"><span class="fa fa-times"></span> Hata bildir!</a>
                    ...
                    <div class="add-comment">
                        ...
                        <form action="" id="addcomment" onsubmit="return false;">
							...
							<div class="no-comment" style="line-height: 21px; padding: 10px; background: rgba(0,0,0,.1); margin-bottom: 12px; font-size: 11px; margin-top: -7px;">
<strong>Dikkat! </strong> Yorum yazarken sadece <u>bölüm ile ilgili</u> olduğundan emin olun. Altyazı ile ilgili yorumlarınızı değerlendirmeler aracılığı ile iletebilirsiniz. Alakasız yorumlar haber verilmeksizin silinecektir.
</div>
                            <div class="formm">
